    ...
    >
      <div>
        <div
          ...
          style={{ display: 'none' }}
          className={formInput.collabsExpanded ? 'taskDeetsExpand' : 'taskDeets'}
        >
          <div id="marginL" style={{ display: 'grid', gridTemplateColumns: '1fr' }}>
            <div className="task-deets-left-line">
              <div
                style={{
          ...
          >
            <div
              ...
              style={{
                ...
                borderBottom:
                  formInput.status === 'closed' ? '2px solid grey' : '2px solid rgb(255, 117, 26, .5)',
              }}
            />
            <div id="empty" />
          </div>
          ...
          >
            ...
            >
              <div id="plan" style={{ paddingLeft: '6px', paddingBottom: '6px' }}>
                <strong>Plan:</strong>
              </div>
              <textarea
          ...
          <div id="taskCollabs" style={{ marginLeft: '3px' }}>
            <ViewTaskCollabsInProj
              formInput={formInput}
              taskId={taskId}
              collabsExpand={formInput.collabsExpanded}
              saveCollabsExpand={formInput.collabsExpanded}
            />
          </div>
        </div>
      </div>
