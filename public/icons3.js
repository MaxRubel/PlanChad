const envelopeArrowUp = (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-arrow-up" viewBox="0 0 16 16">
...
export { envelopeArrowUp, envelopeIcon, peopleIconNoFill };
